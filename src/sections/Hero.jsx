...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="bg-cover bg-center xl:min-h-screen max-xl:py-40 bg-primary  relative flex-1 flex justify-center items-center">
        <img
          src={bigShoeImg}
          alt="shoe collection"
          width={610}
        ...
        >
          {shoes.map((shoe) => (
            <div key={shoe}>
              <ShoeCard
                imgUrl={shoe}
                changeBigShoeImage={(clickedBigShoeImg) => {
                  setBigShoeImg(clickedBigShoeImg);
                }}
